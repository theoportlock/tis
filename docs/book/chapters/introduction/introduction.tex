...
A moral agent is an individual that according to a moral system.
||||||| 45b2d04
...
A moral agent is an individual that acts within a moral system.
>>>>>>> 31adfb0b85f7be295fc3d1f6d9b9706808e991a8
...
\subsection{Interaction between two moral systems}
...
Firstly, a rejection of moral systems manifests as a bipartisan assumption of one another's actions are bad (minus - minus). 
...
Lastly, a mutual acceptance of moral systems is the understanding that the ends described by a moral system converges to the point that their continued actions weighted by their estimated probability is similar to those actions taken by the moral system of another individual (plus - plus).
