...
In a moral system, an event is concidered moraly virtuous (good) or reprehenshible (bad) if its consequences increase, or decrease the probability of a moral end respectively.
